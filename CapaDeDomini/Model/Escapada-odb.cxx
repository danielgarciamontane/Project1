...
namespace odb
{
  ...
  struct access::object_traits_impl< ::Escapada, id_mysql >::extra_statement_cache_type
  {
  ...
  bool access::object_traits_impl< ::Escapada, id_mysql >::
  grow (image_type& i,
        my_bool* t,
        std::size_t d)
  {
  ...
  access::object_traits_impl< ::Escapada, id_mysql >::info (
    typeid (::Escapada),
    &object_traits_impl< ::Experiencia, id_mysql >::info,
    0,
    "Escapada",
    &odb::create_impl< ::Escapada >,
    &odb::dispatch_impl< ::Escapada, id_mysql >,
    &statements_type::delayed_loader);

  static const access::object_traits_impl< ::Escapada, id_mysql >::entry_type
  polymorphic_entry_for_Escapada;
  ...
  const char access::object_traits_impl< ::Escapada, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Escapada`";

  const char access::object_traits_impl< ::Escapada, id_mysql >::table_name[] =
  "`Escapada`";
  ...
  access::object_traits_impl< ::Escapada, id_mysql >::pointer_type
  access::object_traits_impl< ::Escapada, id_mysql >::
  ...
  result< access::object_traits_impl< ::Escapada, id_mysql >::object_type >
  access::object_traits_impl< ::Escapada, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::Escapada, id_mysql >::
