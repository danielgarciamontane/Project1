...
namespace odb
{
  ...
  struct access::object_traits_impl< ::Activitat, id_mysql >::extra_statement_cache_type
  {
  ...
  const char access::object_traits_impl< ::Activitat, id_mysql >::erase_query_statement[] =
  "DELETE FROM `Activitat`";

  const char access::object_traits_impl< ::Activitat, id_mysql >::table_name[] =
  "`Activitat`";
  ...
  access::object_traits_impl< ::Activitat, id_mysql >::pointer_type
  access::object_traits_impl< ::Activitat, id_mysql >::
  ...
  unsigned long long access::object_traits_impl< ::Activitat, id_mysql >::
