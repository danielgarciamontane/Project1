...
namespace odb
{
  ...
  struct pointer_query_columns< ::Reserva, id_mysql, A >
  {
    ...
    static const idReserva_type_ idReserva;
  ...
  template <typename A>
  const typename pointer_query_columns< ::Reserva, id_mysql, A >::idReserva_type_
  pointer_query_columns< ::Reserva, id_mysql, A >::
  idReserva (A::table_name, "`idReserva`", 0);
    ...
    public access::object_traits< ::Reserva >
  {
    ...
    struct image_type
    {
      // _idReserva
      //
      int _idReserva_value;
      my_bool _idReserva_null;

      // _dataReserva
      //
      MYSQL_TIME _dataReserva_value;
      my_bool _dataReserva_null;

      // _numPlaces
      //
      int _numPlaces_value;
      my_bool _numPlaces_null;

      // _preuPagat
      //
      float _preuPagat_value;
      my_bool _preuPagat_null;
  ...
  template <typename A>
  const typename query_columns< ::Reserva, id_mysql, A >::idReserva_type_
